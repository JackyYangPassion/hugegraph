...
@Path("graphs/{graph}/traversers/kneighborv1")
@Singleton
@Tag(name = "KneighborAPIV1")
public class KneighborAPIV1 extends TraverserAPI {

    private static final Logger LOG = Log.logger(KneighborAPIV1.class);
